...
public interface AMQPBridgePolicyManagerControl {
   ...
   /**
    * Returns the type of the AMQP bridge policy manager being controlled
    */
   @Attribute(desc = "AMQP bridge policy manager type that backs this control instance.")
   String getType();

   /**
    * Returns the configured name the AMQP bridge policy manager being controlled
    */
   @Attribute(desc = "The configured AMQP bridge policy name that backs this control instance.")
   String getName();

   /**
    * Returns the number of messages this bridge policy has received from the remote.
    */
   @Attribute(desc = "returns the number of messages this bridge policy has received from the remote")
   long getMessagesReceived();

   /**
    * Returns the number of messages this bridge policy has sent to the remote.
    */
