...
public interface AMQPFederationPolicyControl {
   ...
   /**
    * Returns a unique name the AMQP federation policy manager being controlled
    */
   @Attribute(desc = "AMQP federation policy manager type that backs this control instance.")
   String getName();
    ...
    */
   @Attribute(desc = "returns the number of messages this federation policy has federated from the remote")
