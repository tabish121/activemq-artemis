...
public class AMQPFederationProducerControlType extends AbstractControl implements AMQPFederationProducerControl {
   ...
   public AMQPFederationProducerControlType(AMQPFederationSenderController senderController, ServerConsumer consumer) throws NotCompliantMBeanException {
      super(AMQPFederationConsumerControl.class, senderController.getServer().getStorageManager());
      ...
      this.filterString = consumer.getFilterString().toString();
   }
