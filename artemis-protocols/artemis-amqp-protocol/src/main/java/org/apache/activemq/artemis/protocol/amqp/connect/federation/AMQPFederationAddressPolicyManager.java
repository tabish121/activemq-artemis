...
public class AMQPFederationAddressPolicyManager extends FederationAddressPolicyManager {
   ...
   protected final BiConsumer<FederationConsumerInfo, Message> messageSpy = (i, m) -> messageCount.incrementAndGet();
   ...
   protected FederationConsumerInternal createFederationConsumer(FederationConsumerInfo consumerInfo) {
      ...
      return new AMQPFederationAddressConsumer(this, configuration, session, consumerInfo, messageSpy);
   }
