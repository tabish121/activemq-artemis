 ...
 * configurations.
 */
public class AMQPFederationRemoteAddressPolicyManager extends AMQPFederationRemotePolicyManager {
   ...
   @Override
   public AMQPFederationSenderController newSenderController() throws ActiveMQAMQPException {
      return new AMQPFederationAddressSenderController(this, metrics.newProducerMetrics(), federation.getSessionContext());
   }
}
