...
public class AMQPBridgeToQueueEntry {
   ...
   private AMQPBridgeSenderRecoveryHandler<AMQPBridgeToQueueEntry> recoveryHandler;
    ...
    */
   public AMQPBridgeToQueueEntry setRecoveryHandler(AMQPBridgeSenderRecoveryHandler<AMQPBridgeToQueueEntry> recoveryHandler) {
    ...
    */
   public AMQPBridgeSenderRecoveryHandler<AMQPBridgeToQueueEntry> getRecoveryHandler() {
