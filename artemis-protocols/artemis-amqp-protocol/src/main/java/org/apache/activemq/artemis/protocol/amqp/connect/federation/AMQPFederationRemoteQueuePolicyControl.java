 ...
 */
public class AMQPFederationRemoteQueuePolicyControl extends AbstractControl implements AMQPFederationRemotePolicyControl {

   private final AMQPFederationRemoteQueuePolicyManager manager;

   public AMQPFederationRemoteQueuePolicyControl(ActiveMQServer server, AMQPFederationRemoteQueuePolicyManager manager) throws NotCompliantMBeanException {
