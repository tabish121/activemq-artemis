...
public interface AMQPBridgeReceiverControl {
    ...
    *
    * For Queue bridge this will be the filter that exists on the local queue that
    * is requesting bridge of messages from the remote. For address bridge this
    * filter will be used to restrict some movement of messages amongst bridged server
    * addresses.
    *
    ...
    */
   @Attribute(desc = "the assigned priority of the the bridge receiver.")
   int getPriority();
