...
public abstract class AMQPFederationManagementSupport {
    ...
    */
   public static final String FEDERATION_POLICY_RESOURCE_TEMPLATE = "brokerconnection.federation.policy.%s";
    ...
    */
   public static final String FEDERATION_CONSUMER_RESOURCE_TEMPLATE = "brokerconnection.federation.policy.%s.consumer.%s";
    ...
    */
   public static final String FEDERATION_QUEUE_CONSUMER_NAME_TEMPLATE = FEDERATION_POLICY_NAME_TEMPLATE + ",fqqn=%s";

   /**
    * The template used to create the object name suffix that is appending to the broker connection
    * object name when adding and removing AMQP federation address consumer control elements.
    */
   public static final String FEDERATION_ADDRESS_CONSUMER_NAME_TEMPLATE = FEDERATION_POLICY_NAME_TEMPLATE + ",address=%s";
   ...
   public static ObjectName getFederationPolicyObjectName(ManagementService management, String brokerConnection, String federationName, String policyType, String policyName) throws Exception {
      final ObjectName brokerConnectionName = management.getObjectNameBuilder().getBrokerConnectionObjectName(brokerConnection);

      return ObjectName.getInstance(
         String.format("%s," + FEDERATION_POLICY_NAME_TEMPLATE,
            brokerConnectionName.toString(),
