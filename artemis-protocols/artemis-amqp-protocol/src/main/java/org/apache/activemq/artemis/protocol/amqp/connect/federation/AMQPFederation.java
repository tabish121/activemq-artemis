...
public abstract class AMQPFederation implements FederationInternal {
    ...
    *
    * TODO: Currently the fact that broker connection name is null indicates that the resource
    *       is from a remote broker connection and no management types are registered. This
    *       should be improved upon when remote broker connection management registration
    *       is implemented.
    */
