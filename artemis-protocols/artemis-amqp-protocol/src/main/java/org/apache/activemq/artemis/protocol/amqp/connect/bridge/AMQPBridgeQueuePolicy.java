...
public final class AMQPBridgeQueuePolicy implements BiPredicate<String, String> {
   ...
   public AMQPBridgeQueuePolicy(String policyName, boolean presettle, Integer priority, int priorityAdjustment,
