 ...
 * configurations.
 */
public class AMQPFederationRemoteQueuePolicyManager extends AMQPFederationRemotePolicyManager {
   ...
   public AMQPFederationSenderController newSenderController() throws ActiveMQAMQPException {
      return new AMQPFederationQueueSenderController(this, metrics.newProducerMetrics(), federation.getSessionContext());
   }
}
