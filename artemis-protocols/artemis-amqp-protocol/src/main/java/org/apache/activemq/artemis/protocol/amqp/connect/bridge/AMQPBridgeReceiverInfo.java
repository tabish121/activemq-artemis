...
public class AMQPBridgeReceiverInfo {
   ...
   /**
    * @return the remote address used to populate the address in the Terminus of the AMQP receiver.
    */
   ...
   @Override
   public int hashCode() {
      return Objects.hash(priority, filterString, localAddress, localFqqn, localQueue, remoteAddress, role, routingType);
   }
   ...
   public String toString() {
      return "AMQPBridgeReceiverInfo: { " + getRole() + ", " + getRemoteAddress() + " }";
   }
}
