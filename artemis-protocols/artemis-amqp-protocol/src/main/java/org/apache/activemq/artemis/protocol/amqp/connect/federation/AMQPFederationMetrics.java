...
public final class AMQPFederationMetrics {
    ...
    * when the Metrics are updated by the producer. The consumer Metrics are not
    * updated by more than one thread so the updates do not need to be atomic operations.
    */
    ...
    * when the Metrics are updated by the producer. The producer Metrics are not
    * updated by more than one thread so the updates do not need to be atomic operations.
    */
