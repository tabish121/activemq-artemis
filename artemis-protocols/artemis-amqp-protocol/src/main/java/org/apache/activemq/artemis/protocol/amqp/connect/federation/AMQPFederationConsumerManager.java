...
public abstract class AMQPFederationConsumerManager<E> {
   ...
   /**
    * An event point that a subclass can use to perform a initialization action whenever a entry is added to
    * demand tracking.
    *
   ...
   /**
    * An event point that a subclass can use to perform a cleanup action whenever a entry is removed from
    * demand tracking.
    *
