 ...
 */
public class AMQPFederationBrokerConnectionServiceControl extends AbstractControl implements BrokerConnectionServiceControl {

   private static final String SERVICE_TYPE = "federation";

   private final AMQPFederation federation;

   public AMQPFederationBrokerConnectionServiceControl(AMQPFederation federation, BrokerConnection brokerConnection, StorageManager storageManager) throws NotCompliantMBeanException {
