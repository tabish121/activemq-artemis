...
public abstract class AMQPBridgePolicyManager {
   ...
   /**
    * Start the bridge policy manager which will initiate a scan of all broker bindings
    * and create and matching remote receivers. Start on a policy manager should only be
   ...
   /**
    * Stops the bridge policy manager which will close any open remote receivers that are
