...
public class AMQPBridgeSenderInfo {
   ...
   enum Role {
      /**
       * Sender created from a match on a configured bridge from address policy.
       */
      ADDRESS_SENDER,

      /**
       * Sender created from a match on a configured bridge from queue policy.
       */
      QUEUE_SENDER
   }
   ...
   /**
    * @return the remote address used to populate the address in the Terminus of the AMQP sender.
    */
