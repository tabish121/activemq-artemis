...
public class AmqpSupport {
   ...
   // Default timeout (in milliseconds) before closing a link as failed if a drain is initiated from this peer
   public static final int AMQP_DRAIN_TIMEOUT = 600_000; // ten minutes
