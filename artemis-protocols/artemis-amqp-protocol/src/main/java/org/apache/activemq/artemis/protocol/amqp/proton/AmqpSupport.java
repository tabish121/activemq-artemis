...
public class AmqpSupport {
   ...
   public static final boolean AMQP_DRAIN_CREDIT_FOR_TRANSIENT_DELIVERY_ERRORS = true;

   // Default timeout before closing a link as failed if a drain is initiated from this peer
   public static final int AMQP_DRAIN_TIMEOUT = 600;
