...
public class AMQPBridgeReceiverControlType extends AbstractControl implements AMQPBridgeReceiverControl {
   ...
   public AMQPBridgeReceiverControlType(AMQPBridgeReceiver receiver) throws NotCompliantMBeanException {
      super(AMQPBridgeReceiverControl.class, receiver.getBridge().getServer().getStorageManager());
   ...
   public long getMessagesReceived() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getMessagesReceived(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getRole() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getRole(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getQueueName() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getQueueName(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getAddress() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getAddress(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getFqqn() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getFqqn(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getRoutingType() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getRoutingType(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public String getFilterString() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getFilterString(this.receiverInfo);
      }
      clearIO();
      try {
   ...
   public int getPriority() {
      if (AuditLogger.isBaseLoggingEnabled()) {
         AuditLogger.getPriority(this.receiverInfo);
      }
      clearIO();
      try {
