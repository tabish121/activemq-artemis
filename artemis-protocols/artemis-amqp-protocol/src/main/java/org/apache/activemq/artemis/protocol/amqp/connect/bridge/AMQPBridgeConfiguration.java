...
import static org.apache.activemq.artemis.protocol.amqp.connect.bridge.AMQPBridgeConstants.DEFAULT_PERFER_SHARED_DURABLE_SUBSCRIPTIONS;
...
public class AMQPBridgeConfiguration {
   ...
   public boolean isPreferSharedDuableSubscriptions() {
      ...
      if (property instanceof Boolean) {
         ...
         return DEFAULT_PERFER_SHARED_DURABLE_SUBSCRIPTIONS;
      }
   }
}
