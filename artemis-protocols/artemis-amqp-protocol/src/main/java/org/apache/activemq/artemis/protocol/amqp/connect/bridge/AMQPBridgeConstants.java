...
public final class AMQPBridgeConstants {
   ...
   /**
    * Configuration property used to set the value to use when considering if bridged queue consumers should
    ...
    * one back of credit until local backlog is removed by the addition of a local consumer or a purge of the
    * bridged resource.
    */
    ...
    * value assign to the properties {@link Map} is a signed integer value. This value overrides any
    * other computed value and is set on each bridge receiver so long as the option to disable receiver
    * priority is not set to <code>true</code>.
    */
    ...
    */
   public static final long DEFAULT_LINK_RECOVERY_INITIAL_DELAY = TimeUnit.SECONDS.toMillis(10);
    ...
    */
   public static final long DEFAULT_LINK_RECOVERY_DELAY = TimeUnit.MINUTES.toMillis(1);

   ///// Defaults not associated with a specific bridge policy property.
