...
/**
 * Generalized base class wrapper for an AMQP Message.
 */
public abstract class AMQPMessage extends RefCountMessage implements org.apache.activemq.artemis.api.core.Message {
   ...
   /**
    * The message format that defines the encoding used for the AMQP message
    *
    * @return the assigned message format.
    */
