 ...
 *
 */
public class AMQPOutgoingConnectionContext extends AMQPServerConnectionContext {

   public AMQPOutgoingConnectionContext(AMQPRemotingConnection remotingConnection, Executor executor, Connection connection) {
