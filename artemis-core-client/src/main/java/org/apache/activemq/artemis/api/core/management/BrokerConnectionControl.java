...
public interface BrokerConnectionControl extends ActiveMQComponentControl {
   ...
   /**
    * Returns {@code true} if this broker connection is currently connected to the remote, {@code false} otherwise.
    */
    ...
    */
   @Attribute(desc = "Configured retry interval used by this broker connection")
   long getRetryInterval();

   /**
    * Returns the number of reconnection attempts used by this broker connection.
    */
   @Attribute(desc = "Configured number of reconnection attempts used by this broker connection")
