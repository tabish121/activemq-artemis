 ...
 */
public interface BrokerConnectionServiceControl {

   /**
    * Returns the service type of the broker connection service being controlled
    */
   @Attribute(desc = "service type of this broker connection service")
   String getType();

   /**
    * Returns a unique name the broker connection service being controlled
    */
