...
public class AMQPSenderBrokerConnectionElement extends AMQPBrokerConnectionElement {
   ...
   private String targetAddressPrefix;
   ...
   public String getTargetAddressPrefix() {
      return targetAddressPrefix;
   }

   public void setTargetAddressPrefix(String targetAddressPrefix) {
      this.targetAddressPrefix = targetAddressPrefix;
   }
