...
public class ManagementServiceImpl implements ManagementService {
   ...
   public void registerBrokerConnectionService(String brokerConnection, String catagory, BrokerConnectionServiceControl serviceControl) throws Exception {
      registerInJMX(objectNameBuilder.getBrokerConnectionServiceObjectName(brokerConnection, catagory, serviceControl.getName()), serviceControl);
      registerInRegistry(ResourceNames.BROKER_CONNECTION_SERVICE + serviceControl.getName(), serviceControl);
   }

   @Override
   public void unregisterBrokerConnectionService(String brokerConnection, String catagory, String name) throws Exception {
      unregisterFromJMX(objectNameBuilder.getBrokerConnectionServiceObjectName(brokerConnection, catagory, name));
      unregisterFromRegistry(ResourceNames.BROKER_CONNECTION_SERVICE + name);
   }
